        ...
        <div className="mt-10 mx-auto w-full max-w-sm">
            <form action={formAction}>
                ...
                <div className="mt-6">
                    ...
                    <input type="date" id='dueDate' name='dueDate' min='2020-01-01' max='2999-12-31'  value={dueDate} onChange={(e) => setDueDate(e.target.value)}  required className="block mt-2 py-1.5 px-2 w-full rounded-md border-0 shadow-sm ring-1 ring-inset ring-gray-300" />
                </div>
                <div className="mt-6 flex intems-center">
